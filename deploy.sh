...
docker tag keboola/wr-google-bigquery:$TRAVIS_TAG 147946154733.dkr.ecr.us-east-1.amazonaws.com/keboola/wr-google-bigquery:$TRAVIS_TAG
docker tag keboola/wr-google-bigquery:latest 147946154733.dkr.ecr.us-east-1.amazonaws.com/keboola/wr-google-bigquery:latest
